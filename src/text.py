...
Version: 1.7
Timestamp: 2025-04-18 12:08 CET
...
class TextManager:
    ...
    def format_sentence(self, text):
        ...
        if (
            text
            and starts_sentence
            and not any(text.startswith(abbr) for abbr in self.common_abbreviations)
        ):

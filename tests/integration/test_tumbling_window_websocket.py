...
class TumblingWindowWebSocketTest(unittest.TestCase):
    ...
    def test_audio_flow(self):
        ...
        self.assertGreater(
            len(self.mock_websocket.sent_audio), 0, "WebSocket should receive processed audio"
        )
    ...
    def test_window_size_and_overlap(self):
        ...
        self.assertGreaterEqual(
            len(self.mock_websocket.sent_audio),
            expected_windows * 0.8,
        ...
        for audio_chunk in self.mock_websocket.sent_audio:
            ...
            self.assertEqual(
                len(audio_chunk), window_size * 2, f"Audio chunk should be {window_size} samples"
            )
...
class MainIntegrationTest(unittest.TestCase):
    ...
    def test_main_integration(self, MockAudioProcessor, MockWebSocket):
        ...
        self.assertIsNotNone(client.audio_processor, "AudioProcessor should be initialized")

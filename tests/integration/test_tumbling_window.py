...
class TumblingWindowTest(unittest.TestCase):
    ...
    def test_window_overlap(self):
        ...
        for i in range(1, len(windows)):
            ...
            self.assertGreater(correlation, 0.5, "Windows should have significant correlation in overlap region")
...
class TumblingWindowPerformanceTest(unittest.TestCase):
    ...
    def test_realtime_performance(self):
        ...
        # Verify performance
        print(f"Processed {self.windows_processed} windows with average latency of {self.latency:.2f}ms")

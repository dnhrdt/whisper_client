...
def test_basic_segmentation():
    ...
    # Lauter Abschnitt
    audio[int(0.5*16000):int(1.0*16000)] = np.sin(2*np.pi*440*t[int(0.5*16000):int(1.0*16000)]) * 0.8
    # Leiser Abschnitt
    audio[int(1.5*16000):int(2.0*16000)] = np.sin(2*np.pi*440*t[int(1.5*16000):int(2.0*16000)]) * 0.05
    # Lauter Abschnitt
    audio[int(2.2*16000):int(2.7*16000)] = np.sin(2*np.pi*440*t[int(2.2*16000):int(2.7*16000)]) * 0.7
    ...
    print(f"Gefunden: {len(speech_segments)} Sprach-Segmente von {len(all_segments)} Gesamt-Segmenten")
...
def test_continuous_audio():
    ...
    for i in range(chunks_count):
        # Generiere Chunk
        t = np.linspace(i*chunk_duration, (i+1)*chunk_duration, int(sample_rate*chunk_duration))
